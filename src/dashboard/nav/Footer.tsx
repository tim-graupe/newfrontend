...
export default function Footer() {
    return (
        <footer
            className="text-center bg-neutral-100 text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
            <div
            ...
            <div className="py-10 mx-6 text-center md:text-left">
                <div className="grid gap-8 grid-1 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="">
                        ...
                        <p>
                            This is my submission for The Odin Project's "Odin Book" project.
                        </p>
                    </div>
                    {/* <!-- Products section --> */}
                    <div className="">
                    ...
                    <div>
                        ...
                        <a href='http://github.com/tim-graupe'>
                        ...
                        <a href='https://www.linkedin.com/in/tim-graupe-277490114/'>
                            <p className="flex items-center justify-center mb-4 md:justify-start">
